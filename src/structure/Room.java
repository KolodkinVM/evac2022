...
import java.util.ArrayList;
 ...
 /*Класс, описывающий помещение  (Room, Staircase).      Date of creation (modification)   -  07.06.2022
       @author KVM     */
/*
public class Rooms {

    public String name_zona;				// Название элемента в соответствии с планом
...
public class Element {    //		  26.04.2022       27.05.2022
    ...
    public String floor;			// Название уровня в здании
    public String ZLevel;			// Значение уровня (этажа) помещения, мm
    ...
    public Element() {    };
    public Element(String Id, double dPeople,String floor, String ZLevel, double SizeZ, double Wide, String Name, String Sign,
    ...
    public static ArrayList<graph.Element> getlistElement(structure.BuildingPIM building) {
        ArrayList<graph.Element> listElement = new ArrayList<graph.Element>();        // Список Element (Общий)
